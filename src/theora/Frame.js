    ...
    Constructor.prototype = {
        ...
        decodeCodedBlockFlags() {
            ...
            if (this.ftype === 0) {
                ...
                sbpCoded = this.decodeRunLengthBitString(
                    header.nsbs,
                    constants.LONG_RUN_LENGTH_HUFFMAN_TABLE
                );
                ...
                bits = this.decodeRunLengthBitString(
                    nbits,
                    constants.LONG_RUN_LENGTH_HUFFMAN_TABLE
                );
                ...
                bits = this.decodeRunLengthBitString(
                    nbits,
                    constants.SHORT_RUN_LENGTH_HUFFMAN_TABLE
                );
            ...
            if (this.ftype === 0) {
                ...
                for (mbi = 0; mbi < header.nmbs; mbi += 1) {
                    ...
                    for (bi = mbi * 4; bi < len; bi += 1) {
                        if (this.bcoded[bi] === 1) {
                            if (mScheme !== 7) {
                                mi = this.huffmanTableLookup(
                                    constants.MACRO_BLOCK_MODE_SCHEMES_HUFFMAN_TABLE
                                );
        ...
        decodeMotionVector(mvmode) {
            ...
            if (mvmode === 0) {
                mvx = this.huffmanTableLookup(
                    constants.MOTION_VECTOR_COMPONENTS_HUFFMAN_TABLE
                );
                mvy = this.huffmanTableLookup(
                    constants.MOTION_VECTOR_COMPONENTS_HUFFMAN_TABLE
                );
            } else {
                // Read mvx
                ...
                if (this.mbmodes[mbi] === 7) {
                    ...
                    switch (header.pf) {
                        ...
                        case 2: // (4:2:2) subsampling
                            ...
                            // X component
                            mVector[0] = Math.round(
                                (this.mvects[a][0] + this.mvects[b][0]) / 2
                            );
                            // Y component
                            mVector[1] = Math.round(
                                (this.mvects[a][1] + this.mvects[b][1]) / 2
                            );
                            ...
                            // X component
                            mVector[0] = Math.round(
                                (this.mvects[c][0] + this.mvects[d][0]) / 2
                            );
                            // Y component
                            mVector[1] = Math.round(
                                (this.mvects[c][1] + this.mvects[d][1]) / 2
                            );
                ...
                for (i = 0; i < len; i += 1) {
                    ...
                    if (tis[bi] === ti) {
                        ...
                        if (eobs > 0) {
                            ...
                            token = this.dynamicHuffmanTableLookup(
                                header.hts[hti]
                            );
                            if (token < 7) {
        ...
        computeDCPredictor(bi, lastdc) {
            ...
            if (bri % planeWidth !== 0) {
                ...
                bj =
                    tables.rasterToCodedOrder[bri - 1 + colorPlaneOffsets[pli]];

                if (this.bcoded[bj] !== 0) {
                    mbj = tables.biToMbi[bj];
                    if (
                        rfi ===
                        constants.REFERENCE_FRAME_INDICIES[this.mbmodes[mbj]]
                    ) {
                        p[0] = 1;
                        pbi[0] = bj;
                    }
            ...
            if (bri % planeWidth !== 0 && bri >= planeWidth) {
                ...
                bj =
                    tables.rasterToCodedOrder[
                        bri - 1 - planeWidth + colorPlaneOffsets[pli]
                    ];
            ...
            if (bri >= planeWidth) {
                ...
                bj =
                    tables.rasterToCodedOrder[
                        bri - planeWidth + colorPlaneOffsets[pli]
                    ];
            ...
            if (p[0] === 0 && p[1] === 0 && p[2] === 0 && p[3] === 0) {
                ...
                w =
                    constants.DCPREDICTORS_WEIGHTS_AND_DIVISORS_TABLE[
                        p.join('')
                    ].weights;
                pdiv =
                    constants.DCPREDICTORS_WEIGHTS_AND_DIVISORS_TABLE[
                ...
                if (p[0] !== 0 && p[1] !== 0 && p[2] !== 0) {
                    if (Math.abs(dcpred - this.coeffs[pbi[2]][0]) > 128) {
                        ...
                        Math.abs(dcpred - this.coeffs[pbi[0]][0]) > 128
                    ) {
                        dcpred = this.coeffs[pbi[0]][0];
                    } else if (
                        Math.abs(dcpred - this.coeffs[pbi[1]][0]) > 128
                    ) {
        ...
        invertDCPrediction() {
            ...
            for (pli = 0; pli < 3; pli += 1) {
                ...
                for (bri = 0; bri < len; bri += 1) {
                    bi =
                        tables.rasterToCodedOrder[bri + colorPlaneOffsets[pli]];
                    if (this.bcoded[bi] !== 0) {
                        ...
                        mbi = tables.biToMbi[bi];
                        rfi =
                            constants.REFERENCE_FRAME_INDICIES[
                                this.mbmodes[mbi]
                            ];
                        lastdc[rfi] = dc;
                    }
        ...
        reconstructComplete() {
            ...
            for (i = 0; i < len; i += 1) {
                ...
                if (rfi === 0) {
                    ...
                    mvx =
                        Math.floor(Math.abs(this.mvects[bi][0]) / divX) *
                        util.sign(this.mvects[bi][0]);
                    mvy =
                        Math.floor(Math.abs(this.mvects[bi][1]) / divY) *
                        util.sign(this.mvects[bi][1]);
                    mvx2 =
                        Math.ceil(Math.abs(this.mvects[bi][0]) / divX) *
                        util.sign(this.mvects[bi][0]);
                    mvy2 =
                        Math.ceil(Math.abs(this.mvects[bi][1]) / divY) *
                        util.sign(this.mvects[bi][1]);

                    if (mvx === mvx2 && mvy === mvy2) {
                        pred = this.getWholePixelPredictor(
                            rpw,
                            rph,
                            refp,
                            bx,
                        ...
                        pred = this.getHalfPixelPredictor(
                            rpw,
                            rph,
                            refp,
                            bx,
